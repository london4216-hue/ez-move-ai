  ...
  return (
    <div className="min-h-screen bg-[#0f1117] text-white flex items-center justify-center p-6">
      <div className="max-w-md text-center">
        ...
        <p className="text-slate-400 text-sm mb-6">Access the preview environment:</p>
        <a
        ...
        <p className="text-slate-500 text-xs mt-6">More preview modules will be added soon</p>
      </div>
    </div>
  );
}