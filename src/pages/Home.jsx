    ...
    <div className="min-h-screen bg-[#EFF6FF] text-slate-900">
      ...
      <nav className="px-6 py-5 flex items-center justify-between max-w-5xl mx-auto">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center shadow-lg shadow-orange-900/20">
        ...
        <button
          ...
          className="text-slate-500 hover:text-slate-800 text-sm font-semibold transition-colors px-4 py-2 rounded-xl border border-slate-300 hover:border-slate-400 bg-white"
        >
          Sign In
        </button>
      </nav>
      ...
      <div className="max-w-5xl mx-auto px-6 pt-16 pb-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-stretch justify-center gap-5 mb-16 max-w-2xl mx-auto">
          ...
          <button
            ...
            className="flex-1 bg-white border border-blue-100 rounded-3xl p-6 text-left hover:bg-blue-50 hover:border-blue-200 transition-all group shadow-sm"
          >
      ...
      {/* Features */}
      <div className="bg-white/60 border-t border-b border-blue-100">
        <div className="max-w-5xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={f.title} className="bg-white rounded-3xl p-6 border border-blue-100 shadow-sm">
      ...
      <div className="max-w-5xl mx-auto px-6 py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button
            onClick={() => base44.auth.redirectToLogin("/AgentOnboarding?type=broker")}
            className="w-full sm:w-auto px-8 py-4 rounded-2xl border border-slate-300 text-slate-700 font-bold hover:bg-slate-100 transition-colors"
          >
      ...
      <div className="border-t border-blue-100 py-6 text-center bg-white/40">
